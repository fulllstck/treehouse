...
var product = { name : 'book', inventory: 10, unit_price: 45.99 }
...
function addInventory( prod, number ) {
  ...
  console.log(`${prod.inventory} ${prod.name} added to the inventory`);
}
...
In this example, "chair" is the name of the product.
*/
function processSale( prod, number ) {
  prod.inventory -= number;
  console.log(number + ' ' + prod.name + 's sold');  
  return prod.unit_price *= number;
}
...
"Total sale: $20"
*/
console.log('Total sale: ' + processSale('chair', 2));
